            ...
            <div class="panel-body">
                <ul class="list-unstyled">
                    ...
                    <li>
                        ...
                        <span>Rigser Date  </span>: <?php echo $info['Date']     ?> 
                    </li> 
                    <li>
                        <i class="fa fa-tags fa-fw"></i>
                        <span>Fav Categoty </span>:                                 
                    </li>
                </ul>
                <a href="edit.php?do=profile&id" class="btn btn-primary">Edit Information</a>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="panel-body">
                    <?php
                        ...
                        if (! empty($myItems)) {
                            ...
                            echo 'There Is No Ads To Show Creat <a href="newad.php">New Ads</a';
                        }
                    ?>
                </div>
            </div>
