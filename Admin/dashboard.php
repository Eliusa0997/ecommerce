<?php 
    ...
    if (isset($_SESSION['Username'])) {
        ...
        $numUsers = 5; // number of lateast user

        $latestUsers = getLatest("*", "users", "UserID", $numUsers); // latest user arry

        $numItems = 5; // number of lateast items

        $latestItems = getLatest("*", "items", "Item_ID", $numItems); // latest items arry

        $numComments = 4; // number of lateast items

        $latestComments = getLatest("*", "comments", "c_id", $numComments); // latest items arry
        ...
        <div class="latest">
            <div class="container latest">
                <div class="row">
                    ...
                    <div class="panel panel-default">
                        ...
                        <i class="fa fa-users"></i> 
                        Latest <?php echo $numUsers ?> Registor Users
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                        <i class="fa fa-tag"></i> 
                        Latest <?php echo $numItems ?> Registor Items
                        <span class="toggle-info pull-right">
                            <i class="fa fa-plus fa-lg"></i>
                        </span>
                        </div>
                ...
                <!-- statr lateast comment page -->  
                <div class="row">
                    <div class="col-sm-6">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                        <i class="fa fa-comments"></i> 
                            Latest <?php echo $numComments ?> Commtens
                        <span class="toggle-info pull-right">
                            <i class="fa fa-plus fa-lg"></i>
                                <span></span>
                        </span>
            ...
            <!-- end comment lataest page in dashbord page -->  
